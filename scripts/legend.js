...
const drawLegend = () => {
  ...
  if (getDirection() == 'net') {
    keys = [-500000,-100000,-50000,-10000,-5000,-1000,-500,0.2,500,1000,5000,10000,50000,100000,500000];
  }
  ...
  legend.append("g")
    ...
    .append("circle")
      .attr("cx", x_pos)
      .attr("cy", function(d,i){ return 88 + i*30}) // 100 is where the first dot appears. 25 is the distance between dots
      .attr("r", 18)
  		.attr("stroke","black")
  		.attr("stroke-width","1")
